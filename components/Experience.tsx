  ...
  const projects = [
    {
      ...
      duration: '2022 - 2024',
      location: 'Remote',
      description: 'Led the migration of mission-critical applications from on-premises infrastructure to Azure cloud, serving 2M+ customers.',
      technologies: [
        'Azure App Service',
        'AKS',
        'Azure SQL',
      ...
      achievements: [
        'Successfully migrated 50+ applications to Azure with zero downtime',
